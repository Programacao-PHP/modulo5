...
<body>
    <?php
        ...
        {   
			$pesquisa = $_POST['txt'];
            echo "<p>O texto tem: " . str_word_count($str, 1, 'àÉÁçã') . " palavras.</p>";
			// mb_strlen($str, 'UTF-8'); - conta caracter
			echo "<p>A palavra<b> $pesquisa </b>começa na posição: <b>" . (strpos($str, $pesquisa) + 1) . "</b>.</p>";
			//echo "<p>A palavra<b> $pesquisa </b>começa na posição: <b>" . strstr($str, $pesquisa) . "</b>.</p>";
        }
    ?>
